...
type ResolvedChartBlockResponseSeriesInner struct {
	...
	DataPoints []GetEntityChart200ResponseSeriesInnerDataInner `json:"data_points,omitempty"`
...
// SetDataPoints gets a reference to the given []GetEntityChart200ResponseSeriesInnerDataInner and assigns it to the DataPoints field.
