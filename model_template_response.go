...
// TemplateResponse Template schema details including attribute bindings, default values, and visual groups.
type TemplateResponse struct {
	...
	Attributes []TemplateResponseAttributesInner `json:"attributes,omitempty"`
	// Ordered attribute groups for organizing template fields into visual UI sections.
	Groups []TemplateGroupResponse `json:"groups,omitempty"`
	// Creation timestamp
...
func (o *TemplateResponse) SetSlugNil() {
	o.Slug.Set(nil)
}
...
func (o *TemplateResponse) GetAttributes() []TemplateResponseAttributesInner {
	if o == nil || IsNil(o.Attributes) {
		var ret []TemplateResponseAttributesInner
		return ret
	}
	return o.Attributes
}
...
// SetAttributes gets a reference to the given []TemplateResponseAttributesInner and assigns it to the Attributes field.
...
// SetGroups gets a reference to the given []TemplateGroupResponse and assigns it to the Groups field.
