...
// CreateAttributeRequest Payload for creating a new schema attribute definition.
...
func (o *CreateAttributeRequest) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *CreateAttributeRequest) SetSlugNil() {
	o.Slug.Set(nil)
}
