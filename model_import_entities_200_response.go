...
type ImportEntities200Response struct {
	...
	AffectedEntities []ImportEntities200ResponseAffectedEntitiesInner `json:"affected_entities,omitempty"`
...
func (o *ImportEntities200Response) GetAffectedEntities() []ImportEntities200ResponseAffectedEntitiesInner {
	if o == nil || IsNil(o.AffectedEntities) {
		var ret []ImportEntities200ResponseAffectedEntitiesInner
		return ret
	}
...
// SetAffectedEntities gets a reference to the given []ImportEntities200ResponseAffectedEntitiesInner and assigns it to the AffectedEntities field.
...
func (o ImportEntities200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AffectedEntities) {
		toSerialize["affected_entities"] = o.AffectedEntities
	}
	if !IsNil(o.Errors) {
...
func (o *ImportEntities200Response) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ImportEntities200Response(varImportEntities200Response)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "affected_entities")
