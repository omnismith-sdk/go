...
// CreateDashboardRequest Payload for creating a new analytics and telemetry dashboard canvas. Omnismith dashboards utilize a 12-column grid layout.
type CreateDashboardRequest struct {
	// Display name of the dashboard
	Name string `json:"name"`
	// Detailed description of the dashboard purpose and telemetry scope
	Description *string `json:"description,omitempty"`
	Config *CreateDashboardRequestConfig `json:"config,omitempty"`
...
func (o *CreateDashboardRequest) GetConfig() CreateDashboardRequestConfig {
	if o == nil || IsNil(o.Config) {
		var ret CreateDashboardRequestConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given CreateDashboardRequestConfig and assigns it to the Config field.
